...
public class AlgoBayTest {
    ...
    public void test03CompraSimple() {
        ...
        Assert.assertEquals(6400, algoBay.getPrecioTotalDe(compra), DELTA);
    }
    ...
    public void test05GarantiaCuesta10Porciento() {
        ...
        Assert.assertEquals(2000 * 1.1, algoBay.getPrecioTotalDe(compraSimpleConGarantia), DELTA);
        Assert.assertEquals((2000 * 1.1) + 100, algoBay.getPrecioTotalDe(compraConEnvioYGarantia), DELTA);
    }
    ...
    public void test07CuponDescuento() {
        ...
        Assert.assertEquals((2000 + 100) * 0.8, algoBay.getPrecioTotalDe(compraConEnvio), DELTA);
    }
